...
! function(e, t) {
      ...
      parseUrlQuery: function(e) {
        ...
        if ("string" == typeof o && o.length)
          for (r = (a = (o = -1 < o.indexOf("?") ? o.replace(/\S*\?/, "") : "").split("&").filter(function(e) {
              return "" !== e
            })).length, t = 0; t < r; t += 1) n = a[t].replace(/#\S+/g, "").split("="), i[decodeURIComponent(n[0])] = void 0 === n[1] ? void 0 : decodeURIComponent(n.slice(1).join("=")) || "";
        return i
      },
  ...
  var Framework7 = function(i) {
    ...
    Support = (pp = !1, qp = doc.createElement("div"), "sticky -webkit-sticky -moz-sticky".split(" ").forEach(function(e) {
      pp || (qp.style.position = e, qp.style.position === e && (pp = !0))
    }), mp = pp, np = doc.createElement("div"), {
      positionSticky: mp,
      touch: !!("ontouchstart" in win || win.DocumentTouch && doc instanceof win.DocumentTouch),
      pointerEvents: !(!win.navigator.pointerEnabled && !win.PointerEvent),
      prefixedPointerEvents: !!win.navigator.msPointerEnabled,
      transition: (up = np.style, "transition" in up || "webkitTransition" in up || "MozTransition" in up),
      transforms3d: win.Modernizr && !0 === win.Modernizr.csstransforms3d || (wp = np.style, "webkitPerspective" in wp || "MozPerspective" in wp || "OPerspective" in wp || "MsPerspective" in wp || "perspective" in wp),
      flexbox: function() {
    ...
    pp, qp, wp, up, mp, np, SupportModule = {
      name: "support",
      proto: {
        support: Support
      },
  ...
  function initTouch() {
    ...
    doc.addEventListener("click", function(e) {
      O("click", e)
    }, !0), Support.passiveListener ? (doc.addEventListener(o.touchEvents.start, D, H), doc.addEventListener(o.touchEvents.move, I, H), doc.addEventListener(o.touchEvents.end, L, H), doc.addEventListener(o.touchEvents.start, B, z), doc.addEventListener(o.touchEvents.move, R, z), doc.addEventListener(o.touchEvents.end, A, z)) : (doc.addEventListener(o.touchEvents.start, function(e) {
      D(e), B(e)
      ...
      var t, a, n, r, i = this;
      if (v = m = !1, 1 < e.targetTouches.length) return b && T(), !0;
      if (1 < e.touches.length && b && T(), C.tapHold && (g && clearTimeout(g), g = setTimeout(function() {
          e && e.touches && 1 < e.touches.length || (v = !0, e.preventDefault(), $$1(e.target).trigger("taphold"))
        }, C.tapHoldDelay)), $ && clearTimeout($), t = e.target, a = $$1(t), !(w = !("input" === t.nodeName.toLowerCase() && ("file" === t.type || "range" === t.type) || "select" === t.nodeName.toLowerCase() && Device.android || a.hasClass("no-fastclick") || 0 < a.parents(".no-fastclick").length || C.fastClicksExclude && 0 < a.closest(C.fastClicksExclude).length))) return !(d = !1);
      ...
      })), p - f < C.fastClicksDelayBetweenClicks && e.preventDefault(), C.activeState && (k(b = E(c)) ? y = setTimeout(S, 80) : S()), x && M(c), !0
      ...
      if (d) {
        ...
        m && (d = !1, m = !(c = null), C.tapHold && clearTimeout(g), C.activeState && (clearTimeout(y), T()), x && i())
      }
      ...
      if (doc.activeElement === e.target) return C.activeState && T(), x && P(), !0;
      if (u || e.preventDefault(), i - f < C.fastClicksDelayBetweenClicks) return setTimeout(T, 0), !0;
      if (f = i, d = !1, Device.ios && h && h.scrollTop !== h.f7ScrollTop) return !1;
      if (C.activeState && (S(), setTimeout(T, 0)), x && P(), function(e) {
      ...
      d = !1, c = null, clearTimeout(y), clearTimeout(g), C.activeState && T(), x && P()
    }, {
      passive: !0
      ...
      C.disableContextMenu && (Device.ios || Device.android || Device.cordova) && e.preventDefault(), x && (b && T(), P())
    })
  }
  var TouchModule = {
      name: "touch",
  ...
  function SwipeBack(e) {
    var d, u, h, a, f, m, v, g, b, y, w, $, C, x, t, E = e,
      ...
      B = [],
      R = [],
      A = M[T.theme + "SwipeBackAnimateShadow"],
      z = M[T.theme + "SwipeBackAnimateOpacity"],
      H = M[T.theme + "SwipeBackActiveArea"],
      U = M[T.theme + "SwipeBackThreshold"];

    function r(e) {
      var t = M[T.theme + "SwipeBack"];
      !n || !t || P || T.swipeout && T.swipeout.el || !E.allowPageChange || 0 < $$1(e.target).closest(".range-slider, .calendar-months").length || (P = !(O = !1), d = void 0, D.x = "touchstart" === e.type ? e.targetTouches[0].pageX : e.pageX, D.y = "touchstart" === e.type ? e.targetTouches[0].pageY : e.pageY, a = Utils.now(), y = E.dynamicNavbar, w = E.separateNavbar)
    }
    ...
    function i(e) {
      if (P) {
        ...
        if (void 0 === d && (d = !!(d || Math.abs(a - D.y) > Math.abs(t - D.x)) || t < D.x && !T.rtl || t > D.x && T.rtl), d || e.f7PreventSwipeBack || T.preventSwipeBack) P = !1;
        else {
          if (!O) {
            var n = !1,
              r = $$1(e.target),
              i = r.closest(".swipeout");
            0 < i.length && (!T.rtl && 0 < i.find(".swipeout-actions-left").length && (n = !0), T.rtl && 0 < i.find(".swipeout-actions-right").length && (n = !0)), ((I = r.closest(".page")).hasClass("no-swipeback") || 0 < r.closest(".no-swipeback").length) && (n = !0), L = k.find(".page-previous:not(.stacked)");
            D.x, k.offset().left;
            if (u = k.width(), (T.rtl ? D.x < k.offset().left - k[0].scrollLeft + (u - H) : D.x - k.offset().left > H) && (n = !0), 0 !== L.length && 0 !== I.length || (n = !0), n) return void(P = !1);
            A && 0 === ($ = I.find(".page-shadow-effect")).length && ($ = $$1('<div class="page-shadow-effect"></div>'), I.append($)), z && 0 === (C = L.find(".page-opacity-effect")).length && (C = $$1('<div class="page-opacity-effect"></div>'), L.append(C)), y && (w ? (B = S.find(".navbar-current:not(.stacked)"), R = S.find(".navbar-previous:not(.stacked)")) : (B = I.children(".navbar").children(".navbar-inner"), R = L.children(".navbar").children(".navbar-inner")), x = S[0].offsetWidth, f = B.children(".left, .title, .right, .subnavbar, .fading"), m = R.children(".left, .title, .right, .subnavbar, .fading"), M.iosAnimateNavbarBackIcon && (B.hasClass("sliding") ? (v = B.children(".left").find(".back .icon"), g = B.children(".left").find(".back span").eq(0)) : (v = B.children(".left.sliding").find(".back .icon"), g = B.children(".left.sliding").find(".back span").eq(0)), b = R.hasClass("sliding") ? R.children(".left").find(".back .icon") : R.children(".left.sliding").find(".back .icon"))), 0 < $$1(".sheet.modal-in").length && T.sheet && T.sheet.close($$1(".sheet.modal-in"))
          }
          e.f7PreventPanelSwipe = !0, O = !0, T.preventSwipePanelBySwipeBack = !0, e.preventDefault();
          var o = T.rtl ? -1 : 1;
          (h = (t - D.x - U) * o) < 0 && (h = 0);
          var s = h / u,
            l = {
          ...
          var p = h * o,
            c = (h / 5 - u / 5) * o;
          1 === Device.pixelRatio && (p = Math.round(p), c = Math.round(c)), I.transform("translate3d(" + p + "px,0,0)"), A && ($[0].style.opacity = 1 - 1 * s), "md" !== T.theme && L.transform("translate3d(" + c + "px,0,0)"), z && (C[0].style.opacity = 1 - 1 * s), y && (f.each(function(e, t) {
            var a = $$1(t);
            if (a.is(".subnavbar") || (a[0].style.opacity = 1 - Math.pow(s, .33)), 0 <= a[0].className.indexOf("sliding") || B.hasClass("sliding")) {
    ...
    function o() {
      if (T.preventSwipePanelBySwipeBack = !1, P && O) {
        ...
        var e = Utils.now() - a,
          i = !1;
        (e < 300 && 10 < h || 300 <= e && u / 2 < h) && (I.removeClass("page-current").addClass("page-next" + ("md" === T.theme ? " page-next-on-right" : "")), L.removeClass("page-previous").addClass("page-current").removeAttr("aria-hidden"), $ && ($[0].style.opacity = ""), C && (C[0].style.opacity = ""), y && (B.removeClass("navbar-current").addClass("navbar-next"), R.removeClass("navbar-previous").addClass("navbar-current").removeAttr("aria-hidden")), i = !0), $$1([I[0], L[0]]).addClass("page-transitioning page-transitioning-swipeback").transform(""), y && (f.css({
          opacity: ""
        }).each(function(e, t) {
        ...
        i ? (E.currentRoute = L[0].f7Page.route, E.currentPage = L[0], E.pageCallback("beforeOut", I, B, "current", "next", {
          route: I[0].f7Page.route,
          swipeBack: !0
        }), E.pageCallback("beforeIn", L, R, "previous", "current", {
          ...
          $$1([I[0], L[0]]).removeClass("page-transitioning page-transitioning-swipeback"), y && (f.removeClass("navbar-transitioning").css({
            ...
            opacity: ""
          }).transform(""), v && 0 < v.length && v.removeClass("navbar-transitioning"), b && 0 < b.length && b.removeClass("navbar-transitioning")), n = !0, E.allowPageChange = !0, i ? (1 === E.history.length && E.history.unshift(E.url), E.history.pop(), E.saveHistory(), M.pushState && History.back(), E.pageCallback("afterOut", I, B, "current", "next", {
            route: I[0].f7Page.route,
            swipeBack: !0
          }), E.pageCallback("afterIn", L, R, "previous", "current", {
            route: L[0].f7Page.route,
            swipeBack: !0
          }), M.stackPages && 0 <= E.initialPages.indexOf(I[0]) ? (I.addClass("stacked"), w && B.addClass("stacked")) : (E.pageCallback("beforeRemove", I, B, "next", {
            swipeBack: !0
          }), E.removePage(I), w && E.removeNavbar(B)), k.trigger("swipeback:afterchange", t), E.emit("swipebackAfterChange", t), E.emit("routeChanged", E.currentRoute, E.previousRoute, E), M.preloadPreviousPage && E.back(E.history[E.history.length - 2], {
            preload: !0
          })) : (k.trigger("swipeback:afterreset", t), E.emit("swipebackAfterReset", t)), $ && 0 < $.length && $.remove(), C && 0 < C.length && C.remove()
        })
      } else O = P = !1
    }
    t = !("touchstart" !== T.touchEvents.start || !Support.passiveListener) && {
      passive: !0,
      capture: !1
    }, k.on(T.touchEvents.start, r, t), T.on("touchmove:active", i), T.on("touchend:passive", o), E.on("routerDestroy", function() {
      var e = !("touchstart" !== T.touchEvents.start || !Support.passiveListener) && {
        passive: !0,
        capture: !1
      };
      k.off(T.touchEvents.start, r, e), T.off("touchmove:active", i), T.off("touchend:passive", o)
    })
  }
  ...
  function forward(e, t) {
    ...
    if (s || "popup popover sheet loginScreen actions customModal panel".split(" ").forEach(function(e) {
        r.currentRoute && r.currentRoute.route && r.currentRoute.route[e] && (s = !0, a = e)
      }), s) {
    ...
    if (b.length && r.removeThemeElements(b), m && (h = b.children(".navbar").children(".navbar-inner"), v && (u = r.$navbarEl, 0 < h.length && b.children(".navbar").remove(), 0 === h.length && b[0].f7Page && (h = b[0].f7Page.$navbarEl))), r.allowPageChange = !1, 0 === b.length) return r.allowPageChange = !0, r;
    var w, $ = g.children(".page:not(.stacked)").filter(function(e, t) {
      return t !== b[0]
    });
    if (v && (w = u.children(".navbar-inner:not(.stacked)").filter(function(e, t) {
        return t !== h[0]
      })), o.reloadPrevious && $.length < 2) return r.allowPageChange = !0, r;
    var C = "next";
    if (o.reloadCurrent || o.reloadAll ? C = "current" : o.reloadPrevious && (C = "previous"), b.addClass("page-" + C).removeClass("stacked"), m && h.length && h.addClass("navbar-" + C).removeClass("stacked"), o.reloadCurrent) d = $.eq($.length - 1), v && (f = $$1(i.navbar.getElByPage(d)));
    else if (o.reloadPrevious) d = $.eq($.length - 2), v && (f = $$1(i.navbar.getElByPage(d)));
    else if (o.reloadAll) d = $.filter(function(e, t) {
      return t !== b[0]
      ...
      if (1 < $.length) {
        ...
        for (x = 0; x < $.length - 1; x += 1) {
          var E = i.navbar.getElByPage($.eq(x));
          r.params.stackPages ? ($.eq(x).addClass("stacked"), v && $$1(E).addClass("stacked")) : (r.pageCallback("beforeRemove", $[x], w && w[x], "previous", void 0, o), r.removePage($[x]), v && E && r.removeNavbar(E))
        }
      }
    ...
    if (m && !v && (f = d.children(".navbar").children(".navbar-inner")), r.params.pushState && (o.pushState || o.replaceState) && !o.reloadPrevious) {
      var k = r.params.pushStateRoot || "";
      History[o.reloadCurrent || o.reloadAll || o.replaceState ? "replace" : "push"](n.id, {
        url: o.route.url
      }, k + r.params.pushStateSeparator + o.route.url)
    }
    o.reloadPrevious || (r.currentPageEl = b[0], m && h.length ? r.currentNavbarEl = h[0] : delete r.currentNavbarEl, r.currentRoute = o.route);
    var S = o.route.url;
    o.history && (0 < (o.reloadCurrent && r.history.length) || o.replaceState ? r.history[r.history.length - (o.reloadPrevious ? 2 : 1)] = S : o.reloadPrevious ? r.history[r.history.length - 2] = S : o.reloadAll ? r.history = [S] : r.history.push(S)), r.saveHistory();
    var T = 0 < b.parents(doc).length,
      M = b[0].f7Component;
    if (o.reloadPrevious ? (M && !T ? M.$mount(function(e) {
        $$1(e).insertBefore(d)
      }) : b.insertBefore(d), v && h.length && (f.length ? h.insertBefore(f) : (r.$navbarEl.parents(doc).length || r.$el.prepend(r.$navbarEl), u.append(h)))) : (d.next(".page")[0] !== b[0] && (M && !T ? M.$mount(function(e) {
        g.append(e)
      }) : g.append(b[0])), v && h.length && (r.$navbarEl.parents(doc).length || r.$el.prepend(r.$navbarEl), u.append(h[0]))), T || r.pageCallback("mounted", b, h, C, y ? C : "current", o, d), o.reloadCurrent && 0 < d.length ? r.params.stackPages && 0 <= r.initialPages.indexOf(d[0]) ? (d.addClass("stacked"), v && f.addClass("stacked")) : (r.pageCallback("beforeRemove", d, f, "previous", void 0, o), r.removePage(d), v && f && f.length && r.removeNavbar(f)) : o.reloadAll ? d.each(function(e, t) {
        var a = $$1(t),
          n = $$1(i.navbar.getElByPage(a));
        r.params.stackPages && 0 <= r.initialPages.indexOf(a[0]) ? (a.addClass("stacked"), v && n.addClass("stacked")) : (r.pageCallback("beforeRemove", a, f && f.eq(e), "previous", void 0, o), r.removePage(a), v && n.length && r.removeNavbar(n))
      }) : o.reloadPrevious && (r.params.stackPages && 0 <= r.initialPages.indexOf(d[0]) ? (d.addClass("stacked"), v && f.addClass("stacked")) : (r.pageCallback("beforeRemove", d, f, "previous", void 0, o), r.removePage(d), v && f && f.length && r.removeNavbar(f))), o.route.route.tab && r.tabLoad(o.route.route.tab, Utils.extend({}, o, {
        history: !1,
        pushState: !1
      })), r.pageCallback("init", b, h, C, y ? C : "current", o, d), o.reloadCurrent || o.reloadAll) return r.allowPageChange = !0, r.pageCallback("beforeIn", b, h, C, "current", o), r.pageCallback("afterIn", b, h, C, "current", o), o.reloadCurrent && o.clearPreviousHistory && r.clearPreviousHistory(), r;
    ...
    if (r.pageCallback("beforeIn", b, h, "next", "current", o), r.pageCallback("beforeOut", d, f, "current", "previous", o), o.animate) {
      var D = "md" === r.app.theme ? r.params.materialPageLoadDelay : r.params.iosPageLoadDelay;
      D ? setTimeout(function() {
        O(), r.animate(d, b, f, h, "forward", function() {
          P()
        })
      }, D) : (O(), r.animate(d, b, f, h, "forward", function() {
        P()
      }))
    } else P();
    return r
  ...
  function navigate(e, t) {
    ...
    if ("string" == typeof e ? a = e : (a = e.url, n = e.route, r = e.name, i = e.query, o = e.params), r) {
      if (!(s = l.findRouteByKey("name", r))) throw new Error('Framework7: route with name "' + r + '" not found');
    ...
    return s.route.options ? Utils.extend(u, s.route.options, t, {
      ...
      route: s
    }), u && u.context && (s.context = u.context, u.route.context = u.context), processRouteQueue.call(l, s, l.currentRoute, function() {
      var a;
      a = !1, "popup popover sheet loginScreen actions customModal panel".split(" ").forEach(function(e) {
        s.route[e] && !a && (a = !0, l.modalLoad(e, s, u))
      ...
      }), a || s.route.async && (l.allowPageChange = !1, s.route.async.call(l, s, l.currentRoute, function(a, n) {
  ...
  function tabLoad(d, e) {
    ...
    if (h[0].f7RouterTabLoaded) return f && f.length && (m ? v(function() {
    ...
    function l(e, t) {
      ...
      function p(e) {
        u.allowPageChange = !0, e && ("string" == typeof e ? h.html(e) : (h.html(""), e.f7Component ? e.f7Component.$mount(function(e) {
          h.append(e)
        }) : h.append(e)), h[0].f7RouterTabLoaded = !0, function(e) {
          u.removeThemeElements(h);
          var t = h;
          "string" != typeof e && (t = $$1(e)), t.trigger("tab:init tab:mounted", d), u.emit("tabInit tabMounted", h[0], d), f.length && (m ? v(function() {
            u.emit("routeChanged", u.currentRoute, u.previousRoute, u), u.params.unloadTabContent && u.tabRemove(f, h, d)
          }) : (u.emit("routeChanged", u.currentRoute, u.previousRoute, u), u.params.unloadTabContent && u.tabRemove(f, h, d)))
        }(e))
      }
  ...
  function modalLoad(n, r, e) {
    ...
    function h() {
      ...
      t.on(o + "Open", function() {
        e || (c.removeThemeElements(t.el), t.$el.trigger(n.toLowerCase() + ":init " + n.toLowerCase() + ":mounted", r, t), c.emit((i ? "" : "modalInit") + " " + n + "Init " + n + "Mounted", t.el, r, t)), c.once("swipeBackMove", a)
        ...
        e && e.$destroy(), Utils.nextTick(function() {
          (e || u.component) && c.removeModal(t.el), t.destroy(), delete l.modalInstance
        })
      }), s.route && (c.params.pushState && s.pushState && History.push(c.view.id, {
        url: s.route.url,
        modal: n
      }, (c.params.pushStateRoot || "") + c.params.pushStateSeparator + s.route.url), s.route !== c.currentRoute && (c.currentRoute = Utils.extend(s.route, {
        modal: t
      })), s.history && (c.history.push(s.route.url), c.saveHistory())), e && (c.removeThemeElements(t.el), t.$el.trigger(n.toLowerCase() + ":init " + n.toLowerCase() + ":mounted", r, t), c.emit(o + "Init " + n + "Init " + n + "Mounted", t.el, r, t)), t.open()
    }
    ...
    }), a || "actions" !== n || h(), u.async && u.async.call(c, s.route, c.currentRoute, function(e, t) {
  ...
  function back() {
    for (var e, t = [], a = arguments.length; a--;) t[a] = arguments[a];
    var n, r, i, o = this;
    "object" == typeof t[0] ? r = t[0] || {} : (n = t[0], r = t[1] || {});
    var s = r.name,
      l = r.params,
      p = r.query;
    if (s) {
      if (!(i = o.findRouteByKey("name", s))) throw new Error('Framework7: route with name "' + s + '" not found');
    ...
    if (u || "popup popover sheet loginScreen actions customModal panel".split(" ").forEach(function(e) {
        o.currentRoute.route[e] && (u = !0, d = e)
      }), u) {
      var h = o.currentRoute.modal || o.currentRoute.route.modalInstance || c[d].get(),
        f = o.history[o.history.length - 2],
        m = o.findMatchingRoute(f);
      return !m && f && (m = {
        url: f,
        path: f.split("?")[0],
      ...
      }), m && h ? (o.params.pushState && !1 !== r.pushState && History.back(), o.currentRoute = m, o.history.pop(), o.saveHistory(), o.modalRemove(h), o) : o
    }
    var v = o.$el.children(".page-current").prevAll(".page-previous").eq(0);
    if (!r.force && 0 < v.length) {
      if (o.params.pushState && v[0].f7Page && o.history[o.history.length - 2] !== v[0].f7Page.route.url) return o.back(o.history[o.history.length - 2], Utils.extend(r, {
        force: !0
      })), o;
      var g = v[0].f7Page.route;
      return processRouteQueue.call(o, g, o.currentRoute, function() {
        o.loadBack({
          el: v
        }, Utils.extend(r, {
          route: g
    ...
    if ("#" === n && (n = void 0), n && "/" !== n[0] && 0 !== n.indexOf("#") && (n = ((o.path || "/") + n).replace("//", "/")), !n && 1 < o.history.length && (n = o.history[o.history.length - 2]), (i = o.findMatchingRoute(n)) || n && (i = {
        url: n,
        path: n.split("?")[0],
    ...
    var b, y = {};
    if (i.route.options ? Utils.extend(y, i.route.options, r, {
        route: i
      }) : Utils.extend(y, r, {
        route: i
      }), y && y.context && (i.context = y.context, y.route.context = y.context), y.force && o.params.stackPages && (o.$el.children(".page-previous.stacked").each(function(e, t) {
        t.f7Page && t.f7Page.route && t.f7Page.route.url === i.url && (b = !0, o.loadBack({
          el: t
        }, y))
      }), b)) return o;
    ...
    function w() {
      ...
      "url content component pageName el componentUrl template templateUrl".split(" ").forEach(function(e) {
        var t;
        i.route[e] && !a && (a = !0, o.loadBack(((t = {})[e] = i.route[e], t), y))
      }), a || i.route.async && (o.allowPageChange = !1, i.route.async.call(o, i, o.currentRoute, function(e, t) {
        o.allowPageChange = !1, t && t.context && (i.context ? i.context = Utils.extend({}, i.context, t.context) : i.context = t.context, y.route.context = i.context), o.loadBack(e, Utils.extend(y, t), !0)
      }, function() {
        o.allowPageChange = !0
      }))
    }
    return y.preload ? w() : processRouteQueue.call(o, i, o.currentRoute, function() {
      w()
    }, function() {
      o.allowPageChange = !0
    }), o
  ...
  var Router = function(i) {
    ...
    return i && (e.__proto__ = i), ((e.prototype = Object.create(i && i.prototype)).constructor = e).prototype.animatableNavElements = function(a, n) {
      ...
      }), n && a ? p(a) : n && !a ? (s.xhr && (s.xhr.abort(), s.xhr = !1), s.xhrRequest(n, r).then(function(e) {
    ...
    if (p.on("click", function(e) {
        ...
        if (a && (t.is(p.params.clicks.externalLinks) || r && 0 <= r.indexOf("javascript:"))) {
          ...
          if (a && (e.preventDefault(), s = t.dataset()), r && 0 < r.length && "#" !== r && !i || t.hasClass("back")) {
            var l;
            if (s.view ? l = $$1(s.view)[0].f7View : (l = n.parents(".view")[0] && n.parents(".view")[0].f7View, !t.hasClass("back") && l && l.params.linksView && ("string" == typeof l.params.linksView ? l = $$1(l.params.linksView)[0].f7View : l.params.linksView instanceof View && (l = l.params.linksView))), l || p.views.main && (l = p.views.main), !l || !l.router) return;
      ...
      $$1(doc).on(p.params.touch.fastClicks ? "touchstart" : "touchmove", ".panel-backdrop, .dialog-backdrop, .preloader-backdrop, .popup-backdrop, .searchbar-backdrop", function(e) {
        e.preventDefault()
      }, e)
    }
  }
  ...
  function getData(e, s, t, a, n) {
    ...
    Array.prototype.forEach.call(r, function(e) {
      var t = e.name,
        a = e.value;
      if (0 <= propsAttrs.indexOf(t)) l.props || (l.props = {}), "readonly" === t && (t = "readOnly"), 0 <= booleanProps.indexOf(t) ? l.props[t] = !1 !== a : l.props[t] = a;
      else if ("key" === t) l.key = a;
      else if (0 === t.indexOf("@")) {
        l.on || (l.on = {});
        var n = t.substr(1),
          r = !1,
    ...
    return i.prepatch = function(t, a) {
      t && a && t && t.data && t.data.props && Object.keys(t.data.props).forEach(function(e) {
        booleanProps.indexOf(e) < 0 || (a.data || (a.data = {}), a.data.props || (a.data.props = {}), !0 !== t.data.props[e] || e in a.data.props || (a.data.props[e] = !1))
      })
    }, i && (l.hook = i), l
  }
  ...
  var eventListenersModule = {
    ...
    Framework7Component = function(n, e, t) {
      ...
      var o = r.$render();
      return o && "string" == typeof o ? (o = o.trim(), r.$vnode = vdom(o, r, n, !0), r.el = doc.createElement("div"), patch(r.el, r.$vnode)) : o && (r.el = o), r.$el = $$1(r.el), i.style && (r.$styleEl = doc.createElement("style"), r.$styleEl.innerHTML = i.style, i.styleScoped && r.el.setAttribute("data-f7-" + i.id, "")), r.$attachEvents(), i.created && i.created(), r.el.f7Component = r
    };
  ...
  function parseComponent(e) {
    ...
    s = "window." + n + " = function () {" + s + "}", (l = doc.createElement("script")).innerHTML = s, $$1("head").append(l);
    var u = win[n]();
    if ($$1(l).remove(), win[n] = null, delete win[n], u.template || u.render || (u.template = t, u.templateType = o), u.template && ("t7" === u.templateType && (u.template = Template7.compile(u.template)), "es" === u.templateType)) {
      var h = "window." + r + " = function () {\n        return function render() {\n          return `" + u.template + "`;\n        }\n      }";
      (l = doc.createElement("script")).innerHTML = h, $$1("head").append(l), u.render = win[r](), $$1(l).remove(), win[r] = null, delete win[r]
    }
  ...
  Framework7Component.prototype.$attachEvents = function() {
    ...
    var e = this;
    e.$options.beforeDestroy && e.$options.beforeDestroy(), e.$styleEl && $$1(e.$styleEl).remove(), e.$detachEvents(), e.$options.destroyed && e.$options.destroyed(), e.el && e.el.f7Component && (e.el.f7Component = null, delete e.el.f7Component), e.$vnode && (e.$vnode = patch(e.$vnode, {
      sel: e.$vnode.sel,
      data: {}
    })), Utils.deleteProps(e)
  };
            ...
            if (r) {
              if (c.hasClass("sliding") || 0 < c.length && $) {
                ...
                if (w && n && n.params.iosAnimateNavbarBackIcon) {
                  ...
                  0 < M.length && (S += M[0].offsetLeft)
                }
                c[0].f7NavbarLeftOffset = S, c[0].f7NavbarRightOffset = T
              }
      ...
      setHighlight: function(e) {
        if ("md" === this.theme) {
          ...
          if (0 !== t.length && (t.hasClass("tabbar") || t.hasClass("tabbar-labels"))) {
            ...
            if (0 !== n) {
              0 === a.length && (t.children(".toolbar-inner").append('<span class="tab-link-highlight"></span>'), a = t.find(".tab-link-highlight"));
  ...
  var Modal = function(n) {
      ...
      return n && (e.__proto__ = n), ((e.prototype = Object.create(n && n.prototype)).constructor = e).prototype.onOpen = function() {
        ...
        return t[r ? "removeClass" : "addClass"]("not-animated"), r ? (t.animationEnd(function() {
          o()
        }), t.transitionEnd(function() {
          o()
        }), t.removeClass("modal-in").addClass("modal-out"), n.onClose()) : (t.addClass("not-animated").removeClass("modal-in").addClass("modal-out"), n.onClose(), n.onClosed()), "dialog" === n.type && clearDialogsQueue(), n
      }, e.prototype.destroy = function() {
        var e = this;
  ...
  var Dialog$1 = {
    ...
    Popup = function(s) {
      function e(e, t) {
        ...
        function o(e) {
          var t = e.target;
          if (0 === $$1(t).closest(i.el).length && i.params && i.params.closeByBackdropClick && i.params.backdrop && i.backdropEl && i.backdropEl === t) {
            var n = !0;
    ...
    Sortable = {
      init: function() {
        var l, p, c, d, u, h, f, m, v, g, b, y, a, w, $, C, x, E, k, S, n = this;
        var e = !!n.support.passiveListener && {
          passive: !1,
          capture: !1
        };
        $$1(doc).on(n.touchEvents.start, ".list.sortable .sortable-handler", function(e) {
          l = !(p = !1), c = "touchstart" === e.type ? e.targetTouches[0].pageY : e.pageY, u = $$1(this).parent("li"), a = u.index(), f = u.parents(".sortable");
          ...
          if (l && u) {
            ...
            if (!p) {
              ...
              S = $[0].scrollTop, x = w.offset().top + a, C = w.height() - a - n, u.addClass("sorting"), f.addClass("sortable-sorting"), E = u[0].offsetTop, v = u[0].offsetTop, g = u.parent().height() - E - u.height(), m = u[0].offsetHeight, k = u.offset().top
            }
    ...
    Swipeout = {
      init: function() {
        var l, p, s, c, d, u, h, f, m, v, g, b, y, w, $, C, x, E, k, S, T, M = this,
          P = {};
        ...
        M.on("touchstart", function(e) {
          ...
          if (l) {
            ...
            if (void 0 === s && (s = !!(s || Math.abs(a - P.y) > Math.abs(t - P.x))), s) l = !1;
              ...
              if (T = S = !1, 0 < f.length) {
                var i = b;
                r = i / g, i < -g && (i = -g - Math.pow(-i - g, .8), b = i, 0 < k.length && (T = !0)), "to-left" !== x && (i = r = 0), C.each(function(e, t) {
                  var a = $$1(t);
                  void 0 === t.f7SwipeoutButtonOffset && (a[0].f7SwipeoutButtonOffset = t.offsetLeft), n = t.f7SwipeoutButtonOffset, 0 < k.length && a.hasClass("swipeout-overswipe") && "to-left" === x && (a.css({
                    left: (T ? -n : 0) + "px"
                  }), T ? a.addClass("swipeout-overswipe-active") : a.removeClass("swipeout-overswipe-active")), a.transform("translate3d(" + (i - n * (1 + Math.max(r, -1))) + "px,0,0)")
                })
              }
              if (0 < m.length) {
                var o = b;
                r = o / v, v < o && (o = v + Math.pow(o - v, .8), b = o, 0 < E.length && (S = !0)), "to-right" !== x && (r = o = 0), $.each(function(e, t) {
                  var a = $$1(t);
                  void 0 === t.f7SwipeoutButtonOffset && (a[0].f7SwipeoutButtonOffset = v - t.offsetLeft - t.offsetWidth), n = t.f7SwipeoutButtonOffset, 0 < E.length && a.hasClass("swipeout-overswipe") && "to-right" === x && (a.css({
                    left: (S ? n : 0) + "px"
                  }), S ? a.addClass("swipeout-overswipe-active") : a.removeClass("swipeout-overswipe-active")), 1 < $.length && a.css("z-index", $.length - e), a.transform("translate3d(" + (o + n * (1 - Math.min(r, 1))) + "px,0,0)")
                })
              }
          ...
          if (l && p) {
            ...
            if (e = r < 300 && (d < -10 && "to-left" === x || 10 < d && "to-right" === x) || 300 <= r && Math.abs(b) > o / 2 ? "open" : "close", r < 300 && (0 === Math.abs(b) && (e = "close"), Math.abs(b) === o && (e = "open")), "open" === e) {
              ...
              T && f.find(".swipeout-overswipe")[0].click(), S && m.find(".swipeout-overswipe")[0].click()
    ...
    VirtualList = function(u) {
      ...
      return u && (e.__proto__ = u), ((e.prototype = Object.create(u && u.prototype)).constructor = e).prototype.setListSize = function() {
        ...
        this.items = [], delete this.filteredItems, this.params.cache && (this.domCache = {}), this.update()
  ...
  var Panel = function(p) {
      function e(e, t) {
        ...
        var l = $$1(".panel-backdrop");
        return 0 === l.length && (l = $$1('<div class="panel-backdrop"></div>')).insertBefore(r), Utils.extend(this, {
          app: e,
          side: o,
          effect: s,
          $el: r,
      ...
      return p && (e.__proto__ = p), ((e.prototype = Object.create(p && p.prototype)).constructor = e).prototype.init = function() {
        ...
        if (!l.is(t.root)) {
          ...
          c.length ? i.insertBefore(c) : d.length ? i.insertAfter(c) : t.root.prepend(i), a.once("panelClosed", function() {
        ...
        return e ? function t() {
          u.transitionEnd(function(e) {
            $$1(e.target).is(u) ? (i.hasClass("panel-active") ? a.onOpened() : a.onClosed(), o.css({
              display: ""
            })) : t()
          })
        }() : (a.onOpened(), o.css({
  ...
  var Form = {
      ...
      function e(t, a) {
        ...
        function M(e) {
          if (!g && (o.params.draggableBar || 0 !== $$1(e.target).closest(".range-knob").length)) {
            var t;
            k = !1, S.x = "touchstart" === e.type ? e.targetTouches[0].pageX : e.pageX, S.y = "touchstart" === e.type ? e.targetTouches[0].pageY : e.pageY, g = !0, $ = void 0, C = r.offset().left;
            var a = (t = o.app.rtl ? (C + o.rangeWidth - S.x) / o.rangeWidth : (S.x - C) / o.rangeWidth) * (o.max - o.min) + o.min;
            ...
            }, 70), o.on("change", T), o.setValue(a, !0)
          }
        }
        ...
        function P(e) {
          if (g) {
            var t = "touchmove" === e.type ? e.targetTouches[0].pageX : e.pageX,
              a = "touchmove" === e.type ? e.targetTouches[0].pageY : e.pageY;
            if (void 0 === $ && ($ = !!($ || Math.abs(a - S.y) > Math.abs(t - S.x))), $) g = !1;
            else {
              e.preventDefault();
        ...
        function O() {
          ...
          o.off("change", T), g = !1, x.removeClass("range-knob-active-state"), k && o.$inputEl && !o.dual && o.$inputEl.trigger("change"), k = !1, void 0 !== o.previousValue && (o.dual && (o.previousValue[0] !== o.value[0] || o.previousValue[1] !== o.value[1]) || !o.dual && o.previousValue !== o.value) && (o.$el.trigger("range:changed", o, o.value), o.emit("local::changed rangeChanged", o, o.value))
        }
    ...
    Stepper = function(A) {
      function e(e, t) {
        ...
        function T(e) {
          b || (S || ($$1(e.target).closest(c).length ? E = "increment" : $$1(e.target).closest(d).length && (E = "decrement"), E && (x.x = "touchstart" === e.type ? e.targetTouches[0].pageX : e.pageX, x.y = "touchstart" === e.type ? e.targetTouches[0].pageY : e.pageY, b = !0, y = void 0, function e(t, a, n, r, i, o) {
        ...
        function O() {
          S ? a.params.buttonsEndInputMode && (S = !1, a.endTypeMode(!0)) : w ? w = !1 : a.decrement(!0)
        }

        function D() {
          S ? a.params.buttonsEndInputMode && (S = !1, a.endTypeMode(!0)) : w ? w = !1 : a.increment(!0)
        }

        function I(e) {
          !e.target.readOnly && a.params.manualInputMode && (S = !0, "number" == typeof e.target.selectionStart && (e.target.selectionStart = e.target.value.length, e.target.selectionEnd = e.target.value.length))
        }

        function L(e) {
          13 !== e.keyCode && 13 !== e.which || (e.preventDefault(), S = !1, a.endTypeMode())
        }
        ...
        function R(e) {
          S ? a.typeValue(e.target.value) : e.detail && e.detail.sentByF7Stepper || a.setValue(e.target.value, !0)
        }
        return a.attachEvents = function() {
          d.on("click", O), c.on("click", D), a.params.watchInput && i && i.length && (i.on("input", R), i.on("click", I), i.on("blur", B), i.on("keyup", L)), a.params.autorepeat && (e.on("touchstart:passive", T), e.on("touchmove:active", M), e.on("touchend:passive", P))
        }, a.detachEvents = function() {
          d.off("click", O), c.off("click", D), a.params.watchInput && i && i.length && (i.off("input", R), i.off("click", I), i.off("blur", B), i.off("keyup", L))
        }, a.useModules(), a.init(), a
      }
      return A && (e.__proto__ = A), ((e.prototype = Object.create(A && A.prototype)).constructor = e).prototype.minus = function() {
    ...
    SmartSelect = function(f) {
      function e(e, t) {
        ...
        var n = $$1(o.params.el).eq(0);
        if (0 === n.length) return o;
        if (n[0].f7SmartSelect) return n[0].f7SmartSelect;
        var r = n.find("select").eq(0);
        if (0 === r.length) return o;
        var i = $$1(o.params.valueEl);
        0 === i.length && (i = n.find(".item-after")), 0 === i.length && (i = $$1('<div class="item-after"></div>')).insertAfter(n.find(".item-title"));
        var s = o.params.url;
        s || (s = n.attr("href") && "#" !== n.attr("href") ? n.attr("href") : r.attr("name").toLowerCase() + "-select/"), s || (s = o.params.url);
        var l = r[0].multiple,
          p = l ? "checkbox" : "radio",
          c = Utils.id();
        ...
        return Utils.extend(o, {
          ...
          n.on("click", d), n.on("change", "select", u)
        }, o.detachEvents = function() {
          n.off("click", d), n.off("change", "select", u)
      ...
      return f && (e.__proto__ = f), ((e.prototype = Object.create(f && f.prototype)).constructor = e).prototype.getView = function() {
        var e = this.view || this.params.view;
        if (e || (e = this.$el.parents(".view").length && this.$el.parents(".view")[0].f7View), !e) throw Error("Smart Select requires initialized View");
        return this.view = e
        ...
        if (a.$containerEl = r, a.openedIn = e, a.opened = !0, a.params.virtualList && (a.vl = n.virtualList.create({
          ...
          if ("page" === e && "ios" === n.theme && (i = $$1(n.navbar.getElByPage(r)).find(".searchbar")), a.params.appendSearchbarNotFound && ("page" === e || "popup" === e)) {
            var o = null;
            (o = "string" == typeof a.params.appendSearchbarNotFound ? $$1('<div class="block searchbar-not-found">' + a.params.appendSearchbarNotFound + "</div>") : "boolean" == typeof a.params.appendSearchbarNotFound ? $$1('<div class="block searchbar-not-found">Nothing found</div>') : a.params.appendSearchbarNotFound) && r.find(".page-content").append(o[0])
          }
          var s = Utils.extend({
            el: i,
  ...
  var methods = ["getHours", "getMilliseconds", "getMinutes", "getSeconds", "getTime", "getTimezoneOffset", "getUTCDate", "getUTCDay", "getUTCFullYear", "getUTCHours", "getUTCMilliseconds", "getUTCMinutes", "getUTCMonth", "getUTCSeconds", "now", "parse", "setHours", "setMilliseconds", "setMinutes", "setSeconds", "setTime", "setUTCDate", "setUTCFullYear", "setUTCHours", "setUTCMilliseconds", "setUTCMinutes", "setUTCMonth", "setUTCSeconds", "toDateString", "toISOString", "toJSON", "toLocaleDateString", "toLocaleTimeString", "toLocaleString", "toTimeString", "toUTCString", "UTC", "valueOf"],
    ...
    Calendar = function(p) {
      function e(k, t) {
        ...
        var e, a, n, S = this;
        if (S.params = Utils.extend({}, k.params.calendar, t), "jalali" === S.params.calendarType && Object.keys(S.params.jalali).forEach(function(e) {
            t[e] || (S.params[e] = S.params.jalali[e])
          }), "jalali" === S.params.calendarType ? S.DateHandleClass = IDate : S.DateHandleClass = Date, S.params.containerEl && 0 === (e = $$1(S.params.containerEl)).length) return S;
        S.params.inputEl && (a = $$1(S.params.inputEl)), a && (n = a.parents(".view").length && a.parents(".view")[0].f7View), n || (n = k.views.main);
        var r = "horizontal" === S.params.direction,
          i = 1;
        ...
        function l(e) {
          var t = $$1(e.target);
          S.isPopover() || S.opened && !S.closing && (t.closest('[class*="backdrop"]').length || (a && 0 < a.length ? t[0] !== a[0] && 0 === t.closest(".sheet-modal, .calendar-modal").length && S.close() : 0 === $$1(e.target).closest(".sheet-modal, .calendar-modal").length && S.close()))
        }
        return r && (i = k.rtl ? -1 : 1), Utils.extend(S, {
          app: k,
          $containerEl: e,
          containerEl: e && e[0],
          inline: e && 0 < e.length,
          ...
          attachInputEvents: function() {
            S.$inputEl.on("click", o), S.params.inputReadOnly && S.$inputEl.on("focus mousedown", s)
          },
          detachInputEvents: function() {
            S.$inputEl.off("click", o), S.params.inputReadOnly && S.$inputEl.off("focus mousedown", s)
          },
          ...
          function v(e) {
            n || a || (a = !0, r = "touchstart" === e.type ? e.targetTouches[0].pageX : e.pageX, o = r, i = "touchstart" === e.type ? e.targetTouches[0].pageY : e.pageY, s = i, t = (new S.DateHandleClass).getTime(), f = !(d = 0), h = void 0, l = S.monthsTranslate)
          }

          function g(e) {
            if (a) {
              var t = S.isHorizontal;
              o = "touchmove" === e.type ? e.targetTouches[0].pageX : e.pageX, s = "touchmove" === e.type ? e.targetTouches[0].pageY : e.pageY, void 0 === h && (h = !!(h || Math.abs(s - i) > Math.abs(o - r))), t && h ? a = !1 : (e.preventDefault(), S.animating ? a = !1 : (f = !1, n || (n = !0, p = m[0].offsetWidth, c = m[0].offsetHeight, m.transition(0)), d = (u = t ? o - r : s - i) / (t ? p : c), l = 100 * (S.monthsTranslate * S.inverter + d), m.transform("translate3d(" + (t ? l : 0) + "%, " + (t ? 0 : l) + "%, 0)")))
            }
          }

          function b() {
            a && n ? (n = a = !1, (new S.DateHandleClass).getTime() - t < 300 ? Math.abs(u) < 10 ? S.resetMonth() : 10 <= u ? k.rtl ? S.nextMonth() : S.prevMonth() : k.rtl ? S.prevMonth() : S.nextMonth() : d <= -.5 ? k.rtl ? S.prevMonth() : S.nextMonth() : .5 <= d ? k.rtl ? S.nextMonth() : S.prevMonth() : S.resetMonth(), setTimeout(function() {
              f = !0
            }, 100)) : n = a = !1
          }
          ...
          function y(e) {
            if (f) {
              ...
              if (0 === t.length && $$1(e.target).hasClass("calendar-day") && (t = $$1(e.target)), 0 !== t.length && !t.hasClass("calendar-day-disabled")) {
                ...
                S.emit("local::dayClick calendarDayClick", S, t[0], a, n, r), (!t.hasClass("calendar-day-selected") || S.params.multiple || S.params.rangePicker) && S.addValue(new S.DateHandleClass(a, n, r, 0, 0, 0)), S.params.closeOnSelect && (S.params.rangePicker && 2 === S.value.length || !S.params.rangePicker) && S.close()
              }
            }
          }
          ...
          e.find(".calendar-prev-month-button").on("click", $), e.find(".calendar-next-month-button").on("click", w), e.find(".calendar-prev-year-button").on("click", x), e.find(".calendar-next-year-button").on("click", C), m.on("click", y), S.params.touchMove && (m.on(k.touchEvents.start, v, E), k.on("touchmove:active", g), k.on("touchend:passive", b)), S.detachCalendarEvents = function() {
            e.find(".calendar-prev-month-button").off("click", $), e.find(".calendar-next-month-button").off("click", w), e.find(".calendar-prev-year-button").off("click", x), e.find(".calendar-next-year-button").off("click", C), m.off("click", y), S.params.touchMove && (m.off(k.touchEvents.start, v, E), k.off("touchmove:active", g), k.off("touchend:passive", b))
          }
        }, S.init(), S
      }
  ...
  function pickerColumn(e, t) {
    ...
    if (!l.divider) {
      ...
      l.attachEvents = function() {
        l.$el.on(a.touchEvents.start, k, x), a.on("touchmove:active", S), a.on("touchend:passive", T), l.items.on("click", M)
      }, l.detachEvents = function() {
        l.$el.off(a.touchEvents.start, k, x), a.off("touchmove:active", S), a.off("touchend:passive", T), l.items.off("click", M)
      }, l.init = function() {
  ...
  var Picker = function(c) {
    ...
    PullToRefresh = function(S) {
      ...
      return S && (e.__proto__ = S), ((e.prototype = Object.create(S && S.prototype)).constructor = e).prototype.init = function() {
        this.attachEvents()
      }, e.prototype.destroy = function() {
        var e = this;
    ...
    Searchbar = function(E) {
      ...
      return E && (e.__proto__ = E), ((e.prototype = Object.create(E && E.prototype)).constructor = e).prototype.clear = function(e) {
        ...
        this.emit("local::beforeDestroy searchbarBeforeDestroy", this), this.$el.trigger("searchbar:beforedestroy", this), this.detachEvents(), this.$el[0] && (this.$el[0].f7Searchbar = null, delete this.$el[0].f7Searchbar), Utils.deleteProps(this)
      }, e
    }(Framework7Class),
    Searchbar$1 = {
      name: "searchbar",
    ...
    Messages = function(i) {
      ...
      return i && (e.__proto__ = i), ((e.prototype = Object.create(i && i.prototype)).constructor = e).prototype.getMessageData = function(e) {
        ...
        this.emit("local::beforeDestroy messagesBeforeDestroy", this), this.$el.trigger("messages:beforedestroy", this), this.$el[0] && (this.$el[0].f7Messages = null, delete this.$el[0].f7Messages), Utils.deleteProps(this)
      }, e
    }(Framework7Class),
    Messages$1 = {
      name: "messages",
  ...
  function updateSlides() {
    ...
    if (void 0 !== n) {
      ...
      for (var x, E = t.slidesPerColumn, k = $ / E, S = k - (t.slidesPerColumn * k - p), T = 0; T < p; T += 1) {
        C = 0;
        var M = l.eq(T);
        if (1 < t.slidesPerColumn) {
          var P = void 0,
            O = void 0,
            D = void 0;
          "column" === t.slidesPerColumnFill ? (D = T - (O = Math.floor(T / E)) * E, (S < O || O === S && D === E - 1) && E <= (D += 1) && (D = 0, O += 1), P = O + D * $ / E, M.css({
            "-webkit-box-ordinal-group": P,
            "-moz-box-ordinal-group": P,
            "-ms-flex-order": P,
            "-webkit-order": P,
            order: P
          })) : O = T - (D = Math.floor(T / k)) * k, M.css("margin-" + (e.isHorizontal() ? "top" : "left"), 0 !== D && t.spaceBetween && t.spaceBetween + "px").attr("data-swiper-column", O).attr("data-swiper-row", D)
        }
        if ("none" !== M.css("display")) {
          if ("auto" === t.slidesPerView) {
            ...
            L && (M[0].style.transform = "none"), B && (M[0].style.webkitTransform = "none"), C = e.isHorizontal() ? M[0].getBoundingClientRect().width + parseFloat(I.getPropertyValue("margin-left")) + parseFloat(I.getPropertyValue("margin-right")) : M[0].getBoundingClientRect().height + parseFloat(I.getPropertyValue("margin-top")) + parseFloat(I.getPropertyValue("margin-bottom")), L && (M[0].style.transform = L), B && (M[0].style.webkitTransform = B), t.roundLengths && (C = Math.floor(C))
          } else C = (n - (t.slidesPerView - 1) * g) / t.slidesPerView, t.roundLengths && (C = Math.floor(C)), l[T] && (e.isHorizontal() ? l[T].style.width = C + "px" : l[T].style.height = C + "px");
          l[T] && (l[T].swiperSlideSize = C), u.push(C), t.centeredSlides ? (b = b + C / 2 + y / 2 + g, 0 === y && 0 !== T && (b = b - n / 2 - g), 0 === T && (b = b - n / 2 - g), Math.abs(b) < .001 && (b = 0), t.roundLengths && (b = Math.floor(b)), w % t.slidesPerGroup == 0 && c.push(b), d.push(b)) : (t.roundLengths && (b = Math.floor(b)), w % t.slidesPerGroup == 0 && c.push(b), d.push(b), b = b + C + g), e.virtualSize += C + g, y = C, w += 1
        }
      }
      if (e.virtualSize = Math.max(e.virtualSize, n) + f, r && i && ("slide" === t.effect || "coverflow" === t.effect) && a.css({
        ...
        for (var R = 0; R < c.length; R += 1) {
          var A = c[R];
          t.roundLengths && (A = Math.floor(A)), c[R] < e.virtualSize + c[0] && x.push(A)
        }
        c = x
      }
      if (!t.centeredSlides) {
        ...
        for (var z = 0; z < c.length; z += 1) {
          var H = c[z];
          t.roundLengths && (H = Math.floor(H)), c[z] <= e.virtualSize - n && x.push(H)
        }
  ...
  function onTouchEnd(e) {
    ...
    if (a.isTouched = !1, a.isMoved = !1, a.startMoving = !1, c = n.followFinger ? i ? t.translate : -t.translate : -a.currentTranslate, n.freeMode) {
      ...
      for (var S = 0, T = t.slidesSizesGrid[0], M = 0; M < s.length; M += n.slidesPerGroup) void 0 !== s[M + n.slidesPerGroup] ? c >= s[M] && c < s[M + n.slidesPerGroup] && (T = s[(S = M) + n.slidesPerGroup] - s[M]) : c >= s[M] && (S = M, T = s[s.length - 1] - s[s.length - 2]);
      var P = (c - s[S]) / T;
      if (u > n.longSwipesMs) {
  ...
  var breakpoints = {
    ...
    Browser = {
      ...
      isSafari: (f1a = win.navigator.userAgent.toLowerCase(), 0 <= f1a.indexOf("safari") && f1a.indexOf("chrome") < 0 && f1a.indexOf("android") < 0),
      ...
      function e(n, e) {
        ...
        return r.on("open", function() {
          r.params.swipeToClose && (r.$el.on(n.touchEvents.start, E, {
            passive: !0
          }), n.on("touchmove:active", k), n.on("touchend:passive", S)), $$1(".notification.modal-in").each(function(e, t) {
          ...
          r.params.swipeToClose && (r.$el.off(n.touchEvents.start, E, {
            passive: !0
          }), n.off("touchmove:active", k), n.off("touchend:passive", S)), win.clearTimeout(C)
        }), r
      }
